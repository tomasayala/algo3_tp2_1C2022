...
\subsubsection[]\label{Una moto atraviesa la ciudad y se encuentra con un Pozo. Es penalizada en tres movimientos}

Info sobre 4.1.1

\subsubsection[]\label{Un auto atraviesa la ciudad y se encuentra con un Pozo. Es penalizada en tres movimientos}

Info sobre 4.1.2

\subsubsection[]\label{Una 4x4 atraviesa la ciudad y se encuentra con un Pozo. No es penalizada}
